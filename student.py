        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    #if len(faces) == 0:
                     #   return None
                    # scaling factor=1.3  how much the input image size is reduced at each image scale.
                    # minimum neighbor=5   the minimum number of neighbors required for a detected object to be considered a face.
